...
def compute_overlap_time(range1, range2):
    ...
    for start1, end1 in range1:
        for start2, end2 in range2:
            ...
            high = min(end1, end2)     
            if (datetime.datetime.strptime(high, "%Y-%m-%d %H:%M:%S")  - datetime.datetime.strptime(low, "%Y-%m-%d %H:%M:%S")).total_seconds()  > 0 :
...
if __name__ == "__main__":
    ...
    # print(range1)
    # print(range2)
    range1 = time_range("2022-01-01 03:00:00", "2022-01-01 02:00:00")